...
namespace MyAspNetApp.Controllers
{
    ...
    {
        private readonly MyAspNetApp.Data.AppDbContext _context;
        private readonly ILogger<DashboardController> _logger;

        public DashboardController(MyAspNetApp.Data.AppDbContext context, ILogger<DashboardController> logger)
        {
            _context = context;
            _logger = logger;
        }
