...
namespace NextHorizon.Data.Migrations
{
    ...
    [Migration("20260417023534_AddAgentRankings")]
    partial class AddAgentRankings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NextHorizon.Models.Agent.AgentRanking", b =>
                {
                    ...
                    b.Property<decimal>("AverageQaScore")
                    ...
                    b.HasIndex("PeriodStartUtc", "AgentUserId")
                        .IsUnique();

                    b.HasIndex("PeriodStartUtc", "RankPosition");
