...
public class OrderService
{
    ...
    {
        // If we already have a usable public image path for the product/variant, prefer it
        // to avoid an extra protected endpoint call per image. Otherwise fall back to
        // the OrderItemImage endpoint which can stream binary data or redirect.
