...
namespace NextHorizon.Migrations
{
    ...
    [Migration("20260325063346_AddOrderItemDbSet")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NextHorizon.Models.Product", b =>
                {
                    ...
                    b.Property<string>("ExpectedReleaseDate")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsRestockPreOrder")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("NextHorizon.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NextHorizon.Models.Review", b =>
                {
                    b.HasOne("NextHorizon.Models.Product", null)
                        .WithMany("Reviews")
                        .HasForeignKey("ProductId");
                });
