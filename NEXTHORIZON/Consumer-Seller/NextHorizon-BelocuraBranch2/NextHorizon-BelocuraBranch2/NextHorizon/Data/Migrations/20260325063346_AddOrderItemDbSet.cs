    ...
    public partial class AddOrderItemDbSet : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    logistics_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    courier_name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Logistics", x => x.logistics_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRestockPreOrder = table.Column<bool>(type: "bit", nullable: false),
                    ExpectedReleaseDate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PreOrderNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RestockDate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RestockNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
