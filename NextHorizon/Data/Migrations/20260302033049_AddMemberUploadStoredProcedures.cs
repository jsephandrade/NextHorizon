...
namespace NextHorizon.Migrations
{
    ...
    public partial class AddMemberUploadStoredProcedures : Migration
    {
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.sp_MemberUpload_Delete;");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.sp_MemberUpload_Update;");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.sp_MemberUpload_GetAll;");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.sp_MemberUpload_GetMy;");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.sp_MemberUpload_Create;");
        }
    }
}
